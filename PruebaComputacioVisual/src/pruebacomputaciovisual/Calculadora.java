...
public class Calculadora extends javax.swing.JFrame {
    ...
    public static String calculadora(String num1, String num2, String simbolo) {
    ...
    private void initComponents() {
        ...
        Casilla.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Casilla, javax.swing.GroupLayout.PREFERRED_SIZE, 319, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        // TODO add your handling code here:
        String resultado;
        num2 = Casilla.getText();

        if (!num2.equals("")) {
            resultado = calculadora(num1, num2, simbolo);
            Casilla.setText(resultado);
        }
    }//GEN-LAST:event_jButton18ActionPerformed

    public static boolean existpunto(String cad) {
        boolean resultado;
        resultado = false;

        for (int i = 0; i < cad.length(); i++) {
            if (cad.substring(1, 1 + 1).equals(".")) {
                resultado = true;
                break;
            }
        }
